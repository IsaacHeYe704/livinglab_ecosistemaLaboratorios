  ...
  return (
    <>
      <div className="labDetail__container">
        <div className="LabDetail__header">
          <div
        ...
        <div className="LabDetail__footer">
          ...
          <p className="LabDetail__viewMore" onClick={()=> setshowDetails(false)}>
            Ver detalles{" "}
            <svg
              width="15"
              height="10"
            ...
            >
              <path
                d="M2.47656 0.947266L7.47656 6.09426L12.4766 0.947266L14.4766 1.97666L7.47656 9.18246L0.476562 1.97666L2.47656 0.947266Z"
                fill="#192A67"
              />
            </svg>
          </p>
